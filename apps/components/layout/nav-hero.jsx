import { siteTitle, siteDescription } from '@/config/setting';
...
function NavHero() {
  const SOCIAL_ICONS = [
    {
      href: 'https://facebook.com/andriandev2000/',
          ...
          <div className="col-12 text-center">
            ...
            <p className="lead fs-6">
              {SOCIAL_ICONS.map((item, i) => (
                <a href={item.href} target="_blank" rel="noopener" key={i}>
